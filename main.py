...
class WordCascadeHandler(webapp2.RequestHandler):
    def get(self):
        template = JINJA_ENVIRONMENT.get_template("/static/word-cascade/index.html")
        self.response.write(template.render())


class WordChainHandler(webapp2.RequestHandler):
    def get(self):
        template = JINJA_ENVIRONMENT.get_template("/static/word-chain/index.html")
        self.response.write(template.render())
