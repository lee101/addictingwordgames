...
class WordMergeBattleHandler(webapp2.RequestHandler):
    def get(self):
        template = JINJA_ENVIRONMENT.get_template("/static/word-merge-battle/index.html")
        self.response.write(template.render())
...
routes = [
    ...
    ('/word-merge-battle', WordMergeBattleHandler),
    ('/game/(.*)', GameHandler),
